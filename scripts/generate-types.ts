...
const MODULES: readonly ModuleSpec[] = [
  ...
  {
    name: "contracts",
    schemas: ["profile", "default", "rights", "advantages", "tasks", "bodyPost", "bodyPut"],
  },
  {
    name: "flags",
    schemas: ["search", "profile", "bodyPost", "bodyPut"],
  ...
  {
    name: "alerts",
    schemas: ["search", "configuration", "configurationBodyPut", "values"],
  },
  {
    name: "bankingTransactions",
    schemas: ["search", "profile", "bodyPut"],
  },
  {
    name: "targets",
    schemas: ["profile", "bodyPost", "bodyPut"],
  },
  {
    name: "marketplace",
    schemas: [
  ...
  {
    name: "documents",
    schemas: ["profile", "profileBodyPut"],
  },
  {
    name: "savedsearches",
    schemas: ["search", "profile", "bodyPost", "bodyPut"],
  ...
  {
    name: "forms",
    schemas: ["profile", "default", "rights", "tasks"],
  },
  {
    name: "groupments",
    schemas: ["profile", "default", "rights", "bodyPost", "bodyPut"],
  ...
  {
    name: "technicalDatas",
    schemas: ["profile", "default", "bodyPost", "bodyPut", "resumeBodyPut", "visitorAccess"],
  },
  {
    name: "invoicingConnections",
    schemas: ["search", "profile", "bodyPost", "bodyPut"],
  },
  {
    name: "subscription",
    schemas: ["profile", "bodyPut"],
  },
  {
    name: "vendor",
    schemas: ["profile", "bodyPut"],
